...
<head>
	...
	<script>
		$(function() {
			...
			$('#userrolemanger').datagrid({
				...
				striped : true,
				collapsible : true,
				url : 'userManger/AdminManger_List.action',
				sortName : 'code',
				sortOrder : 'desc',
				remoteSort : false,
				idField : 'adminId',
				...
				columns : [ [ 
					...
					{field : 'adminType',title : 'User Type',align : 'center',width : $(this).width() * 0.15,rowspan : 2,sortable : true,
		...
		function clearAddForm(){
			 ...
			 document.getElementById("addAdminBirth").value="";   
			 document.getElementById("addAdminRemarks").value="";
			 document.getElementById("AddAdminTel").value="";
			 $('#addAdminSex').combobox('setValue','0');
			 $('#addAdminBirth').datetimebox('setText', ''); 
		}
		function addClose(){
			clearAddForm();
		...
		function append() {
			$('#addAdminPanel').dialog('open').dialog('setTitle', 'User Add');
		}
		function addSave() {
			$('#add_admin').form('submit', {
				url : 'userManger/AdminManger_Add.action',
				onSubmit : function() {
		...
		function editWriteDate(rows){
		 	 ...
		 	 document.getElementById("editAdminType").value=rows[0].adminType;        
  ...
  <body>
  	...
  	<div id="class_toolbar" style="padding :4px;text-align:right" >   	
	      	<span><font size=2>UserName:</font></span>
		    <input id="usernumberinput"  type="text"/>
			<a class="easyui-linkbutton" iconCls="icon-search" onclick="finduser()">Find</a>
    </div>
  
 <div id="authoritydisplay" style="display:none">
  	<!---------------------------------------------------------增加管理员--------------------------------------->
	<div id="addAdminPanel" class="easyui-dialog" style="width:400px;height:520px;top:100px;padding:10px" closed="true" buttons="#dlg-button1">
		<form id="add_admin">
			<ul>
				<li>
					...
					<input id="addAdminName" name="adminForm.adminName" style="width:178px;" class="easyui-validatebox" required="true" validType="maxLength[40]" missingMessage="40字符以内" 
				...
				<li>
					...
					<input id="addAdminPassWord" name="adminForm.adminPassWord" style="width:178px;" class="easyui-validatebox" required="true" missingMessage="只能为数字"
				...
				<li>
					...
					<select id="addAdminType"  class="easyui-combobox" name="adminForm.adminType"  panelHeight="50" required="true">
				...
				<li>
					...
					<select id="addAdminSex"  class="easyui-combobox" name="adminForm.adminSex"  panelHeight="50" required="true">
				...
				<li>
					...
					<input id="addAdminBirth" name="adminForm.adminBirth" class="easyui-datetimebox">
				</li>
				<br>
				<br>
				<li>
					...
					<input id="AddAdminTel" name="adminForm.adminTel" style="width:178px;" class="easyui-validatebox" required="true" validType="maxLength[12]" missingMessage="只能为数字"
					type='text' onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" 
					/>
				</li>
				<br>
				...
				<li>
					...
					<input id="addAdminRemarks" name="adminForm.adminRemarks" class="easyui-textbox" data-options="multiline:true" value="" style="width:178px;height:100px">
				</li>
	...
	<div id="dlg-button1">
	<right>
		<a href="#" class="easyui-linkbutton" iconCls="icon-ok" onclick="javascript:addSave()">Save</a> 
		<a href="#" class="easyui-linkbutton" iconCls="icon-cancel" onclick="javascript:addClose()">Cancel</a>
	</right>
	...
	<div id="editAdminPanel" class="easyui-dialog" style="width:360px;height:480px;top:100px;padding:10px" closed="true" buttons="#dlg-button2">
		<form id="edit_admin">
			...
			<input id="editAdminType" name="adminForm.adminType" style="display:none;">
			<ul>
				<li>
					<label  class="required">
						User Name：
