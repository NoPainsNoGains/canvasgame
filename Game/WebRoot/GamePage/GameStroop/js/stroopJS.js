...
/*    document.getElementById("black").style.fontSize= "30%";
    document.getElementById("blue").style.fontSize= "30%";
    document.getElementById("yellow").style.fontSize= "30%";
    document.getElementById("green").style.fontSize= "30%";
    document.getElementById("red").style.fontSize= "30%";*/
