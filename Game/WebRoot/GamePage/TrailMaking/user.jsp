...
<head lang="en">
    <meta charset="UTF-8">
        ...
        <script type="text/javascript">
            ...
            function loginAdmin(){
	        	  setTimeout(function(){document.location.href="../../userAdmin.jsp";}, 4000);
            }
        </script>
</head>
<body style="overflow-y: hidden"> 
    ...
    <div class="body">
        <div class="left">
            <iframe style="background: white" id="gameIframe" class="game" src="TrailMaking.jsp"  scrolling="no" ></iframe>
        </div>
        <div class="right">
             <div class="ru">
