...
<body style="overflow-y: hidden"> 
    <div class="head" style="height:60px; background:#333;"></div>
    <div class="body">
        <div class="left">
            <iframe style="background: white" id="gameIframe" class="game" src="gonogoVisitor.jsp"  scrolling="no" ></iframe>
        </div>
        <div class="right">
             <div class="ru">
